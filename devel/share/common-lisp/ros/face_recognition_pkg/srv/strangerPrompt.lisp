...
(cl:in-package face_recognition_pkg-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <strangerPrompt-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'strangerPrompt-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name face_recognition_pkg-srv:<strangerPrompt-request> is deprecated: use face_recognition_pkg-srv:strangerPrompt-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<strangerPrompt-request>)))
  ...
  "face_recognition_pkg/strangerPromptRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'strangerPrompt-request)))
  "Returns string type for a service object of type 'strangerPrompt-request"
  "face_recognition_pkg/strangerPromptRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <strangerPrompt-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'strangerPrompt-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name face_recognition_pkg-srv:<strangerPrompt-response> is deprecated: use face_recognition_pkg-srv:strangerPrompt-response instead.")))

(cl:ensure-generic-function 'respond-val :lambda-list '(m))
(cl:defmethod respond-val ((m <strangerPrompt-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader face_recognition_pkg-srv:respond-val is deprecated.  Use face_recognition_pkg-srv:respond instead.")
  (respond m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<strangerPrompt-response>)))
  ...
  "face_recognition_pkg/strangerPromptResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'strangerPrompt-response)))
  "Returns string type for a service object of type 'strangerPrompt-response"
  "face_recognition_pkg/strangerPromptResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'strangerPrompt)))
  ...
  "face_recognition_pkg/strangerPrompt")